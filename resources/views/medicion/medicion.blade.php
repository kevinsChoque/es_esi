...
<div class="main-header p-1">
    <div class="row">
        <div class="col-lg-6 col-sm-6 col-12 m-auto">
            <h6 class="my-0 ml-3">Listar Medicion</h6>
        </div>
        ...
        <div class="col-md-12 contenedorFormulario">
            <div class="card card-default card-info card-outline">
                ...
                <div class="card-header border-transparent py-2">
                    <h3 class="card-title m-0 font-weight-bold"><i class="fa-solid fa-ruler"></i> Fechas de Medicion</h3>
                </div>
                <div class="card-body">
                            ...
                            <table id="registros" class="table table-hover table-striped table-bordered dt-responsive nowrap">
                                <thead class="thead-dark">
                                    <tr>
                                        ...
                                        <th class="text-center" data-priority="3">Medicion</th>
            ...
            success: function(result){
                ...
                for (var i = 0; i < result.data.length; i++) 
                {
                    ...
                    html += '<tr class="text-center">' +
                        ...
                        '<td class="align-middle bg-primary">' + 'aaa' + '</td>' +
                        '<td class="align-middle">'+
